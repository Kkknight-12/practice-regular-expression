/*
 * A character class in regular expressions is a set of
 * characters enclosed in square brackets []. It makes the
 * regular expression match any single character within the set.
 * For example, the character class [abc] will match any single
 ...
 *
 * You can also use a caret ^ at the start of a character
 * class to invert it.
 * For example, [^abc] matches any character that is
 * not 'a', 'b', or 'c'.
 * */
